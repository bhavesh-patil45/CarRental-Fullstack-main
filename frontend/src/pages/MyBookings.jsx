        ...
        {bookings.map((booking, index)=>(
          ...
          key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
            ...
            <div className='md:col-span-1'>
              ...
              <p className='text-gray-500'>{booking.car.year} • {booking.car.category} • {typeof booking.car.location === 'object' ? booking.car.location.city : booking.car.location}</p>
            </div>
            ...
            <div className='md:col-span-2'>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  ...
                  <p>{typeof booking.car.location === 'object' ? booking.car.location.city : booking.car.location}</p>
                </div>
              </div>
            </div>
